...
all_parts = ['MX-510B1', 'MX-510TL', 'PSEL-1134FCZZ', 'PSEL1133FCZ1', 'VHi0MFP2504C', 'MX-230B1', 'PHHEZ0844QSZZ',
              ...
              'MX-61GVBA', 'MX-60GRSA', 'MX-407MK', 'MX-600FB', 'MX-607LH', 'NROLR2KITFCZZ', 'MX-600FB', 'MX-607LH', 'MX-36GRSA', 'MX-230MK',
              'MX-230B1', 'MX-230TL', 'MX-850DF', 'MX-62GRSA', 'MX-750MK', 'MX-62GVSB', 'MX-31GRSA', 'MX-510MK', 'MX-51GVSA', 'MX-31GRSA', 'MX-510MK',
              'AR-620RT', 'JC73-00340A', 'AR-620RT', 'AR-620RT', 'AR-620RT']
for i in all_parts:
    parts.add(i)
x = int(len(parts))
